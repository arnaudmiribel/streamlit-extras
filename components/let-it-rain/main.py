...
# st.write("### Animation config")

# emoji = st.text_input("Emoji/text", value="🎈")
# font_size = st.slider("Font size", 12, 128, 54, format="%dpx")
# falling_speed = st.slider("Fall speed", 1, 30, 5, format="%ds")
# infinite = st.checkbox("Animation lasts forever", True)
# if infinite:
#     animation_length = "infinite"
# else:
#     animation_length = st.slider("Animation length", 1, 5, 2, format="%ds")

# rerun = st.button("Update animation")
